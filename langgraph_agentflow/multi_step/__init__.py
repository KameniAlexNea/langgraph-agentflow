...
def create_multi_step_agent(
    ...
    execute_fn = create_execute_step_function(llm, agent_descriptions, prompts["executor"])
...
def invoke_multi_step_agent(graph: CompiledStateGraph, query: str, config: Optional[Dict] = None):
    """
